...
export default function Home() {
  return (
    <div className="min-h-screen relative">
      <OnlineOrderPopup
        orderUrl="https://www.clover.com/online-ordering/masakali-indian-cuisinec-cupertino"
        storageKey="masakali_california_online_order_popup_seen_v1"
      />
        ...
        <div className="max-w-5xl mx-auto px-4 relative z-10">
          <AnimatedSection className="text-center">
            ...
            <p className="text-neutral-600 dark:text-neutral-400 text-lg mb-8 max-w-2xl mx-auto">
              Masakali Indian Cuisine is now serving in Silicon Valley.
            </p>
